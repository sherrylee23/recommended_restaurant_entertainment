...
class _AdminDashboardState extends State<AdminDashboard> {
    ...
    _statusSubscription = Supabase.instance.client
        ...
        .onPostgresChanges(
          ...
          callback: (payload) {
            ...
            // trigger alert banner when user's status = waiting_for_agent
  ...
  // display a material banner for alert
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(child: ClipRRect(child: _adminPages[_selectedIndex])),
            ],
          ),
        ],
      ),
